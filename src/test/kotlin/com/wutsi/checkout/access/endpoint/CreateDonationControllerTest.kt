...
public class CreateDonationControllerTest {
    @LocalServerPort
    ...
    @Test
    @Sql(value = ["/db/clean.sql", "/db/CreateDonationController.sql"])
    fun success() {
        // GIVEN
    ...
    private fun url() = "http://localhost:$port/v1/transactions/donate"
}
